...
OBJDIR = obj
CC = g++
SOURCES = main.cpp test_rectangle_array.cpp test_pointer_array.cpp comparator_func.cpp work_with_buffer.cpp sort_func.cpp calc_textdata.cpp struct_pointer_array.cpp output.cpp
